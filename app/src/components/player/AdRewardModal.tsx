...
const styles = StyleSheet.create({
  ...
  subtitle: { color: 'rgba(255,255,255,0.7)', fontSize: 14, textAlign: 'center', marginBottom: 4 },
  pointsHighlight: { color: COLORS.gold, fontWeight: '700' },
  hint: { color: 'rgba(255,255,255,0.4)', fontSize: 12, marginBottom: 20 },
  watchBtn: {
    width: '100%',
    paddingVertical: 14,
    borderRadius: 12,
  ...
  adLabel: { color: 'rgba(255,255,255,0.3)', fontSize: 10, fontWeight: '700', letterSpacing: 2, marginBottom: 8 },
  adFakeContent: { color: '#FFF', fontSize: 18, fontWeight: '700' },
  adFakeSub: { color: 'rgba(255,255,255,0.5)', fontSize: 13, marginTop: 4 },
  countdownRing: {
    width: 56,
    height: 56,
    borderRadius: 28,
  ...
  countdownText: { color: '#FFF', fontSize: 24, fontWeight: '700' },
  waitText: { color: 'rgba(255,255,255,0.5)', fontSize: 13, marginTop: 8 },
  // Claim phase
  claimBox: { alignItems: 'center', width: '100%' },
  claimEmoji: { fontSize: 40, marginBottom: 8 },
  claimTitle: { color: '#FFF', fontSize: 22, fontWeight: '700', marginBottom: 4 },
  claimPoints: { color: COLORS.gold, fontSize: 28, fontWeight: '800', marginBottom: 20 },
  claimBtn: {
    width: '100%',
    paddingVertical: 14,
    borderRadius: 12,
